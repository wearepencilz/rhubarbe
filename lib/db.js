...
// Launches (Launch-First CMS Model)
export async function getLaunches() {
  return getData('launches')
}

export async function saveLaunches(launches) {
  return saveData('launches', launches)
}

// Modifiers (Launch-First CMS Model)
export async function getModifiers() {
  return getData('modifiers')
}

export async function saveModifiers(modifiers) {
  return saveData('modifiers', modifiers)
}

// Products (Launch-First CMS Model - replaces Offerings)
