...
export default function DatePickerField({ label, ...props }: DatePickerFieldProps) {
  return (
    <AriaDatePicker {...props} className="flex flex-col gap-1">
      {label && (
        <AriaLabel className="text-xs text-gray-500 uppercase tracking-wide">{label}</AriaLabel>
      )}
      <AriaGroup className="flex items-center border-b border-gray-300 focus-within:border-gray-900 transition-colors">
        ...
        <AriaButton className="px-1 text-gray-400 hover:text-gray-600 outline-none">
