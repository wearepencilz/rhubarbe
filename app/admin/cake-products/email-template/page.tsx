...
const AVAILABLE_VARIABLES = [
  ...
  { variable: '{{pickupDate}}', description: 'Requested pickup date' },
  { variable: '{{numberOfPeople}}', description: 'Number of people the cake serves' },
  { variable: '{{eventType}}', description: 'Type of event (birthday, wedding, corporate, other)' },
  { variable: '{{variantBreakdown}}', description: 'List of variants with quantities' },
  { variable: '{{specialInstructions}}', description: 'Customer special instructions (omitted if empty)' },
...
export default function CakeEmailTemplatePage() {
  ...
  return (
    <EditPageLayout
      title="Cake Order Confirmation Email"
              ...
              fields={[
                {
                  ...
                  label: 'Subject',
                  type: 'input',
                  placeholder: 'e.g., Your cake order #{{orderNumber}} is confirmed',
                },
              ]}
            />
          </SectionCard>
